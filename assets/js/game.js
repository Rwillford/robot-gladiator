...
var startGame = function() {
  ...
  for(var i = 0; i < enemyInfo.length; i++) {
    if (playerInfo.health > 0) {
      ...
      //pass the pickedEnemy.name variable's value into the fight function, when it will assume the value of the enemy.name parameter
...
var endGame = function() {
  ...
  //ifplayer has more money than high score, player has the new high score!
  ...
  var playAgainConfirm = window.confirm("Would you like to playu again?");
